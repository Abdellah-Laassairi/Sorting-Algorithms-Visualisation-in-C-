...
int main() {
  ...
  table=stockdata(nom);
  //writedata(table);
  VecAllumette test5=generationAleatoire(100);
  ...
  VecAllumette allumette_random=generationAleatoire(20);

  auto start_i = high_resolution_clock::now();
  VecAllumette all1=tri_insertion(20,allumette_random);
...
/*
   ...
   VecAllumette all2=tri_bulle(100,allumette_random);
  ...
  cout << "temps d'execution Tri par bulle: "<< duration_b.count() << " microsecondes" << endl;
   ...
   VecAllumette all3=tri_rapide(allumette_random,0,99);
  ...
  cout << "temps d'execution Tri Rapide: "<< duration_c.count() << " microsecondes" << endl;
   ...
   VecAllumette values=tri_rapide(allumette_random,0,99);
